...
[![x-cmd/install — mcat Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/mcat.svg?lang=zh)](https://x-cmd.com/install/mcat)
...
合计: **12,547** 行代码（覆盖前 5 种语言、共 **51** 个文件）。
...
- **Star**: 1,418 · **Fork**: 51 · **开放 issue**: 70 · **贡献者**: 9

## 累计统计

- **发布数**: 33 · **已合并 PR**: 22 · **开放 PR**: 1 · **已关闭 issue**: 59 · **开放 issue**: 11 · **提交数**: 613

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 1 | 0 | 0 | 1 | 4 | 9 |
| last60d | 2026-07-26 | 2 | 1 | 0 | 5 | 5 | 30 |
| 90d | 2026-06-26 | 3 | 3 | 0 | 7 | 5 | 40 |
| last180d | 2026-03-28 | 14 | 5 | 0 | 17 | 8 | 186 |
| 360d | 2025-09-29 | 17 | 11 | 1 | 42 | 11 | 276 |
| last720d | 2024-10-04 | 33 | 22 | 1 | 59 | 11 | 613 |
...
mcat 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `mcat` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/mcat.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:40:02Z._
